...
export default function SearchPage() {
  ...
  const handleLiveLookup = async () => {
    ...
    try {
      ...
      setLiveResult({ query: q, detected_type: null, timestamp: new Date().toISOString(), sources_queried: [], results: [], ai_summary: null, ai_analysis: null, errors: ["Live lookup failed. Try again later."] });
    } finally {
